...
import { Phone, AlertTriangle, Activity, Grip, Mic, Volume2, MoreVertical } from "lucide-react";
          ...
          <div className="relative w-full h-full bg-linear-to-b from-gray-950 to-gray-900 p-6 flex flex-col pt-16">
            ...
            <div className="flex-1">
              <motion.div
                ...
                <div className="flex justify-between mt-2 text-xs text-yellow-300/70">
                  ...
                  <span className="font-bold text-yellow-400">20/100</span>
                </div>
              </motion.div>
            </div>
