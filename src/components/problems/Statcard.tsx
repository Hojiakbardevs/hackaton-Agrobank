...
export const StatCard = ({ value, label, icon, delay = 0 }: StatCardProps) => {
    return (
        ...
        >
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r from-red-500 via-orange-500 to-red-600 rounded-2xl opacity-0 group-hover:opacity-100 blur transition-all duration-500 group-hover:blur-md" />
            ...
            <div className="relative h-full bg-card/95 backdrop-blur-xl rounded-2xl p-8 border border-border overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    {icon && (
                        <motion.div
                            className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-red-500/10 to-orange-500/10 text-red-500 mb-6 group-hover:scale-110 transition-transform duration-300"
                ...
                >
                    ...
                    <div className="absolute top-0 right-0 w-1 h-full bg-gradient-to-b from-red-500 to-transparent" />
                </motion.div>
            </div>
        </motion.div>
    );
