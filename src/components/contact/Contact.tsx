...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setFormData({ name: '', email: '', phone: '', message: '', projectType: 'antifraud' });
    }, 3000);
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className="w-full py-4 bg-gradient-to-r from-primary to-emerald-500 text-white rounded-lg font-semibold hover:from-primary/90 hover:to-emerald-500/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          ...
          >
            ...
            {/* Quick Response */}
            <motion.div
              className="bg-gradient-to-r from-primary/20 to-emerald-500/20 backdrop-blur-sm rounded-2xl p-6 border border-primary/30"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
