...
export const BackgroundEffects = () => {
    return (
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
            ...
            <div className="absolute -bottom-[10%] -left-[5%] w-[30%] h-[30%] bg-gradient-to-tr from-primary/20 to-primary/8 blur-[130px] rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />

            {/* Top center floating glow */}
            <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[25%] h-[25%] bg-primary/6 blur-[100px] rounded-full opacity-70 animate-pulse" style={{ animationDelay: '3s' }} />

            {/* Right side vertical glow */}
            <div className="absolute top-1/2 -right-[8%] -translate-y-1/2 w-[20%] h-[40%] bg-gradient-to-l from-primary/15 to-transparent blur-[120px] rounded-full opacity-60" style={{ animationDelay: '2.5s' }} />
                ...
                return (
                    <motion.div
                        ...
                        style={{
                            width: `${size}px`,
                            height: `${size}px`,
                            background: `radial-gradient(circle, rgba(0, 204, 105, ${Math.random() * 0.3 + 0.2}) 0%, transparent 70%)`,
